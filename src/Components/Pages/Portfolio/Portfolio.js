    ...
    <div className="container">
      ...
      <div className="portfolio">
        <div className="example">
          ...
          <p>
            A professional website for musician, songwriter, and music producer
            Kate Ortiz.
            <br></br>
            <br></br>
        ...
        <div className="example">
          ...
          <p>
            My second project for my coding bootcamp. With this website the user
            sees the top ten trending movies on the homepage. They can then log
